/* Modified by David Parlevliet - 2012-01-10
 * https://github.com/dparlevliet/backbone.simplerouter
 * Modifications only Copyright (c) 2012 David Parlevliet; Licensed MIT */
...
(function(Backbone, _) {
  ...
  _.extend(Backbone.Router.prototype, {
    ...
    route: function(route, name, callback) {
      ...
      if( !callback ) {
        if (!this.page)
          throw new Exception('"page" callback was not found.')
        callback = this.page;
      }
      ...
      var wrappedCallback = _.bind( function() {
        ...
        // Convert our arguments to an array. Then, set the first two
        // parameters (0&1) to be the route and the view name. Then,
        // append our original parameters from 2->n and update the new
        // length.
        var args = Array.prototype.slice.call(arguments);
        length = 2;
        arguments[0] = route;
        arguments[1] = name;
        for (x=0;x<args.length+0;x++) {
          arguments[x+2] = args[x];
          length++;
        }
